...
<nav class="duration-[0.5s] dark:text-gray-400 dark:bg-[#1D2946] z-[12] mb-[40px] text-[25.6px] w-full fixed bg-[#3F5A99] h-[50px] text-black text-center border-b-2 border-black">
